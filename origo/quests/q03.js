...
const QUEST = {
  ...
  book:{ page:3, kicker:{en:'Introduction',zh:'入门之'}, title:{en:'Give Numbers Names',zh:'给数起名字'},
    blocks:[
      {top:true, fig:'gnname', prose:{en:'A number is easy once you can count it. But an amount you cannot count yet? Give it a <b>name</b>, a letter such as <b>x</b>. Now you can reason with it before you know its size, and fill the value in later. The same name means the same amount; a different amount gets a different letter (a, b, c).'}},
      {law:{en:'Write it short'}, eq:'5 × <span class="b">x</span> = 5<span class="b">x</span>', fig:'gjux', prose:{en:'Now write with the name. Five of them is <b>5x</b>: number in front, and drop the times-sign because <b>×</b> is the twin of the letter <b>x</b>. Two names, <b>a × b</b>, become <b>ab</b>; and <b>x</b> alone means <b>1x</b>.'}},
      {law:{en:'Name an amount that is not a whole number'}, eq:'<span class="b">3</span> × <span class="r">x</span> = <span class="gr">3x</span>', fig:'garea', prose:{en:'A field <b class="b">3</b> tall and <b class="r">x</b> wide grows <b class="gr">3x</b> grass, and <b class="r">x</b> need not be a whole number: it can be 2.5, or a third, or any length at all. The name carries the amount whatever it turns out to be.'}},
      {law:{en:'Summarize a pattern with ease'}, eq:'<span class="gr">ab</span> = <span class="gr">ba</span>', fig:'glaw', prose:{en:'Name <b>both</b> sides: a field <b class="b">a</b> tall and <b class="r">b</b> wide has area <b class="gr">ab</b>. Put <b>any</b> amount in for <b class="b">a</b> and any for <b class="r">b</b>, and <b class="gr">ab = ba</b> still holds. So instead of writing 1×2 = 2×1, 1×3 = 3×1, 2×3 = 3×2, … on forever, we write it once, for every number at once.'}}
    ],
    read:{en:'A letter names an amount before you fill in its value. Five of them is 5x. The amount need not be a whole number. And one line in letters, like ab = ba, says in a single stroke what would take forever to write out number by number.'} },
