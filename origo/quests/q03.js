...
const QUEST = {
  ...
  book:{ page:3, kicker:{en:'Introduction',zh:'入门之'}, title:{en:'Give Numbers Names',zh:'给数起名字'},
    blocks:[
      {top:true, fig:'gnname', prose:{en:'A number is easy once you can count it. But an amount you cannot count yet? Give it a <b>name</b>, a letter such as <b>x</b>. Now you can reason with it before you know its size, and fill the value in later. The same name means the same number; a different amount gets a different letter (a, b, c).'}},
      {law:{en:'Write it short: 5x'}, eq:'5 × <span class="b">x</span> = 5<span class="b">x</span>', fig:'gjux', prose:{en:'Now write with the name. Five of them is <b>5x</b>: number in front, and drop the times-sign because <b>×</b> is the twin of the letter <b>x</b>. Two names, <b>a × b</b>, become <b>ab</b>; and <b>x</b> alone means <b>1x</b>.'}},
      {law:{en:'Two lengths make an area'}, eq:'<span class="b">3</span> × <span class="r">x</span> = <span class="gr">3x</span>', fig:'garea', prose:{en:'Multiply two named lengths to get an <b>area</b>. A field <b class="b">3</b> tall and <b class="r">x</b> wide grows <b class="gr">3x</b> grass: drop the times-sign, number in front. Fill the name in to read a real amount: if <b class="b">x</b> = 4, the area is <b class="gr">12</b>.'}},
      {law:{en:'Both sides a name'}, eq:'<span class="b">a</span> × <span class="r">b</span> = <span class="gr">ab</span>', fig:'glaw', prose:{en:'Name <b>both</b> sides: a field <b class="b">a</b> tall and <b class="r">b</b> wide has area <b class="gr">ab</b>. The laws you proved by counting hold for every number: <b class="gr">ab = ba</b>, and <b>a(b+c) = ab + ac</b>.'}},
      {note:{en:'<b>Next.</b> A field of area <b>1</b> that is <b class="r">x</b> wide must be <b>1/x</b> tall: even that height has a name.'}}
    ],
