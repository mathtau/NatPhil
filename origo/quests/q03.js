...
const QUEST = {
  ...
  book:{ page:3, kicker:{en:'Introduction',zh:'入门之'}, title:{en:'Give Numbers Names',zh:'给数起名字'},
    blocks:[
      ...
      {law:{en:'Name an amount that is not a whole number',zh:'给不是整数的量起名'}, eq:'<span class="b">3</span> × <span class="r">x</span> = <span class="gr">3x</span>', fig:'garea', prose:{en:'A field <b class="b">3</b> tall and <b class="r">x</b> wide grows <b class="gr">3x</b> grass, and <b class="r">x</b> need not be a whole number: it can be 2.5, or a third, or any length at all. The name carries the amount whatever it turns out to be.',zh:'一片高 <b class="b">3</b>、宽 <b class="r">x</b> 的田长出 <b class="gr">3x</b> 的草，而 <b class="r">x</b> 不必是整数：它可以是 2.5，可以是三分之一，可以是任意长度。不管它最后是多少，这个名字都替它装着。'}},
