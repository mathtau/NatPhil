...
const QUEST = {
  ...
  meta:{ title:{en:'Area by the Donut Rings',zh:'甜甜圈法求面积'}, giver:{en:'Master Curvo · The Coil',zh:'曲师 Curvo · 盘卷'},
    flavor:{en:'"One proof, <b class="p">Pi</b> sneers, proves nothing — so let us measure the disk a SECOND way, and meet the tool that powers everything still to come. Slice the <b class="r">radius</b> into thin <b class="y">rings</b>, each one tiny step <b class="r">dx</b> wide. Unroll a ring and it becomes a strip: <b class="r">dx</b> tall, its rim long. Stack every strip, short to tall, and they lean into a <b class="g">triangle</b> — base the <b class="r">radius</b>, height the rim <b class="y">τ</b>. Its area? <b class="y">½τ</b> — the very same as the pizza cut. Two roads, one truth: <b class="p">Pi</b> cannot argue with that. Catch him out, and the little <b class="r">dx</b> is yours to keep."',
      zh:'"一种证法，<b class="p">Pi</b> 冷笑，算不得数——那就用<b>第二种</b>办法再量一遍圆盘，顺便认识那件驱动后续一切的工具。把<b class="r">半径</b>切成一圈圈细<b class="y">环</b>，每环宽一小步 <b class="r">dx</b>。把一个环摊开，就成一条带：高 <b class="r">dx</b>，长是它的圆边。把每条带从短到长摞起来，它们斜成一个<b class="g">三角</b>——底是<b class="r">半径</b>，高是圆边 <b class="y">τ</b>。面积呢？<b class="y">½τ</b>——和披萨切法分毫不差。两条路，同一个真相：<b class="p">Pi</b> 无从狡辩。当场拆穿他，那小小的 <b class="r">dx</b> 就归你了。"'} },
