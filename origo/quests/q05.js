...
function round1(E){ E.setSpeaker('tau'); E.mood('idle'); E.setDots(0); E.sceneStop(); PIST='cover'; pmood='idle';
  ...
  E.tell(t({en:'<b>Circle Glade.</b> <b class="p">Pi the Halver</b> is squatting right on top of your circle, <b>covering the whole top half</b>! <b class="r">O</b> is the center and Curvo\'s rod marks <b class="r">1</b>. A circle is <b>every</b> point exactly <b class="r">one rod</b> from <b class="r">O</b> — tap them <b>all the way around</b>; each point you claim shoves <b class="p">Pi</b> up and off. (A couple sit too near or too far — leave those.)',
    zh:'<b>圆环林。</b><b class="p">半圆贩子</b>正赖在你的圆上，<b>把上半圈整个盖住了</b>！<b class="r">O</b> 是圆心，Curvo 的量尺标出 <b class="r">1</b>。圆，就是<b>所有</b>到 <b class="r">O</b> 恰好<b class="r">一根尺</b>远的点——把它们<b>绕一整圈</b>逐个点出；每点出一个，就把 <b class="p">Pi</b> 往上顶开一分。（有一两个太近或太远，别点。）'}));
  prog();
...
function round3(E){ E.setSpeaker('tau'); E.mood('idle'); E.setDots(2); E.sceneStop(); PIST='loom'; pmood='idle'; pSad=0;
  ...
  function win(){ bg(); odot(true,true); ring(GOLD,5);
    ...
    E.tell(t({en:'<b class="y">τ</b> ≈ <b>6.28</b> = <b>2π</b> — once around the unit circle. It takes <b>two</b> of <b class="p">Pi</b>\'s halves to close the turn, which is exactly why <b class="p">π</b> alone leaves the <b class="p">Rift</b> open. The <b class="y">Great Circle</b> closes, <b class="p">Pi the Halver</b> is driven off, the <b class="p">Fog</b> recoils. <b>First Law:</b> write <b class="y">τ</b> for a full turn, never π — π is only half.',
      zh:'<b class="y">τ</b> ≈ <b>6.28</b> = <b>2π</b>——绕单位圆一整圈。要<b>两个</b> <b class="p">Pi</b> 的半圈才能合拢一整圈，这正是为什么单用 <b class="p">π</b> 会让<b class="p">裂隙</b>合不上。<b class="y">大圆</b>合拢，<b class="p">半圆贩子</b>被赶跑，<b class="p">迷雾</b>退去。<b>第一定律：</b>整圈写 <b class="y">τ</b>，绝不写 π——π 只是一半。'}));
...
const QUEST = {
  ...
  meta:{ title:{en:'The Whole Way Around',zh:'绕行一整圈'}, giver:{en:'Master Curvo · The Coil',zh:'曲师 Curvo · 盘卷'},
