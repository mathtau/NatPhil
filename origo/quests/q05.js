/* ORIGO · Quest 5 = MathO p9 · "Circumference of the Unit Circle" — OPENS Act I: The Coil (Circle → Calculus).
   ...
   GREEN, τ GOLD. Every action is a right/wrong decision (hearts apply via the engine). Mentor: Master Curvo, the Baker (the Round Kitchen).
...
const QUEST = {
  ...
  meta:{ title:{en:'Measure the circle’s edge (once around)',zh:'量出圆的边（绕行一圈）'}, giver:{en:'Master Curvo · The Coil',zh:'曲师 Curvo · 盘卷'},
    flavor:{en:'"Welcome to <b>The Coil</b>, Pathfinder, and to my <b>Round Kitchen</b>, where every good thing is round. I am <b class="p">Curvo</b>, the Baker. At the world\'s heart the Unravelling has torn a <b class="p">Rift</b>, and only the <b class="y">Great Circle</b>, one perfect full turn, can seal it. But the <b class="p">Fog</b> scattered its measure, so <b class="y">Tau</b>\'s charge falls short of all the way round and the <b class="p">Rift</b> gapes. Start with the humblest round thing I bake: the <b class="y">unit circle</b>, a dough-wheel whose every point sits one rod from <b class="r">O</b>. Measure its crust all the way round, one whole turn, and you have <b class="y">τ</b>. Beware <b class="p">Pi the Halver</b> at the stall next door, who sells only half-pizzas and swears half a turn is plenty. Measure the <b>whole</b> turn, drive him off, and Tau can charge all the way round again. Roll up your sleeves!"',
      zh:'"欢迎来到<b>盘卷</b>，开拓者，也欢迎来到我的<b>圆灶坊</b>，这里好东西都是圆的。我是面点师 <b class="p">Curvo</b>。在世界的心脏，「大解体」撕开了一道<b class="p">裂隙</b>，只有<b class="y">大圆</b>，完整的一整圈，才能把它封上。可<b class="p">迷雾</b>把它的尺度打散了，<b class="y">Tau</b> 的冲刺差一点绕不满整圈，<b class="p">裂隙</b>就一直裂着。先从我烤的最朴素的圆做起：<b class="y">单位圆</b>，一张面饼轮，每个点都离 <b class="r">O</b> 一根尺。把它的脆边绕量一整圈，一整圈就是 <b class="y">τ</b>。当心隔壁摊的<b class="p">半圆贩子</b>，他只卖半块披萨，咬定半圈就够。把<b>整整一圈</b>量出来、把他赶走，<b class="y">Tau</b> 就能再次冲满整圈。卷起袖子，开工吧！"'} },
  ...
  book:{ page:5, kicker:{en:'The Coil',zh:'盘卷之'}, title:{en:'Circumference of the Unit Circle',zh:'单位圆的周长'},
    blocks:[
      ...
      {law:{en:'The whole way around is <span class="y">τ</span>',zh:'绕满一整圈就是 <span class="y">τ</span>'}, eq:'(1+···) × <span class="r">6</span> = <span class="y">τ</span> ≈ 6.28', fig:'utau', prose:{en:'Add the six <b class="y">arcs</b>: a little more than 6, about <b>6.28</b>. This is <b class="y">τ</b>, the distance once around the unit circle, the most important constant in this book.',
        zh:'把六段<b class="y">弧</b>加起来：比 6 多一点，大约 <b>6.28</b>。这就是 <b class="y">τ</b>，绕单位圆一整圈的长度，本书最重要的常数。'}},
      {note:{en:'<b>First Law.</b> We write <b class="y">τ</b> for a whole turn and never <b class="p">π</b>. A full turn (<b class="y">τ</b> ≈ 6.28) is the natural unit; <b class="p">π</b> ≈ 3.14 is only <b>half</b> a turn, and half-turns make most later formulas fight you. Whenever you see <b class="y">τ</b>, a circle is hidden nearby.',
        zh:'<b>第一定律。</b>整整一圈我们写 <b class="y">τ</b>，绝不写 <b class="p">π</b>。一整圈（<b class="y">τ</b> ≈ 6.28）才是自然的单位；<b class="p">π</b> ≈ 3.14 只是<b>半圈</b>，而半圈会让后面大多数公式别扭。凡是见到 <b class="y">τ</b>，附近必藏着一个圆。'}}
    ],
