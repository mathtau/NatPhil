...
FIG.tauBull = function(mood, age){ mood=mood||'open'; age=age||'calf';   // age hook: 'calf' now; 'young'/'adult' grow later
  ...
  const Q='_'+(FIG._tid=(FIG._tid||0)+1);   // unique gradient ids per call — multiple inlined emblems must not share ids (else url(#..) fills break)
  return '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><defs>'
   +'<linearGradient id="hd'+Q+'" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#ffe9a0"/><stop offset=".5" stop-color="#f4c830"/><stop offset="1" stop-color="#c2900f"/></linearGradient>'
   +'<radialGradient id="mz'+Q+'" cx="50%" cy="30%" r="80%"><stop offset="0" stop-color="#fff1c8"/><stop offset="1" stop-color="#e3ad28"/></radialGradient>'
   +'<linearGradient id="nb'+Q+'" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#fff0c4"/><stop offset="1" stop-color="#c8920f"/></linearGradient>'
   +'<linearGradient id="rg'+Q+'" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#fff7e0"/><stop offset=".5" stop-color="#e8b53a"/><stop offset="1" stop-color="#946f10"/></linearGradient>'
   +'<radialGradient id="gl'+Q+'" cx="50%" cy="46%" r="56%"><stop offset="0" stop-color="rgba(244,200,48,.22)"/><stop offset="1" stop-color="rgba(244,200,48,0)"/></radialGradient>'
   +'<radialGradient id="ck'+Q+'" cx="50%" cy="50%" r="50%"><stop offset="0" stop-color="rgba(255,150,120,.5)"/><stop offset="1" stop-color="rgba(255,150,120,0)"/></radialGradient>'
   +'<style>.ey{fill:none;stroke:#241a05;stroke-width:3.6;stroke-linecap:round}</style></defs>'
   +'<circle cx="50" cy="50" r="50" fill="url(#gl'+Q+')"/>'
   ...
   +'<path d="M40 27 C 38 19 47 18 47 26 C 47 30 41 31 40 27 Z" fill="url(#nb'+Q+')" stroke="#9c7412" stroke-width="0.8"/>'
   +'<path d="M60 27 C 62 19 53 18 53 26 C 53 30 59 31 60 27 Z" fill="url(#nb'+Q+')" stroke="#9c7412" stroke-width="0.8"/>'
   +'<path d="M24 41 C 24 30 35 25 50 25 C 65 25 76 30 76 41 C 78 51 74 61 66 67 C 60 71 55 73 50 73 C 45 73 40 71 34 67 C 26 61 22 51 24 41 Z" fill="url(#hd'+Q+')" stroke="#8a6410" stroke-width="1.6"/>'
   +'<path d="M47 28 C 45 23 51 21 52 26 C 53 29 49 31 47 28 Z" fill="#d9a51c" stroke="#a9821f" stroke-width="0.6"/>'
   +'<ellipse cx="30" cy="58" rx="5" ry="3.5" fill="url(#ck'+Q+')"/><ellipse cx="70" cy="58" rx="5" ry="3.5" fill="url(#ck'+Q+')"/>'
   + eyes
   +'<path d="M39 57 C 39 52 61 52 61 57 C 62 64 56 68 50 68.5 C 44 68 38 64 39 57 Z" fill="url(#mz'+Q+')" stroke="#8a6410" stroke-width="1.3"/>'
   ...
   +'<circle cx="50" cy="69.5" r="4" fill="none" stroke="url(#rg'+Q+')" stroke-width="2.4"/>'
